...
//*Only one large rock so only check for case where rock is directly in the middle. 
int main() {
    ...
    //!I need to start off adding the 0!
    
    vector <int> curr = {start[0], start[1], 0};
    ...
    while (queue.size() >0) {
        ...
        if (curr[0] == end[0] && curr[1] == end[1]) {
            //!I have this crazy number generated why? -> Because I initially didn't include 2nd element. 
            //Subtract 1 because number of cows. 
            cout << curr[2]-1;
            break;
        }
